...
import honkSfx from './honk.mp3';

function Honker({ honking }) {
  const [playHonk] = useSound(honkSfx);
  ...
  return (
    <div id="honkWrapper">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512">
        ...
        <g className={honking && "honk"} id="bottombeak">
        ...
        <g className={honking && "honk"} id="topbeak">
        ...
        <g className={honking && "honk"} id="honks">
